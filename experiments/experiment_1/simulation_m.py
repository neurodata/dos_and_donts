...
if __name__ == "__main__":
    ...
    for sample_size in np.linspace(10, 100, 10):
        ...
        ie = IndependentEdge(sample_size=sample_size,
                             n_vertices=10, epsilon=0.001, delta=0.05)
        power = ie.calculate_power(
            ttest_ind, mannwhitneyu, fisher_exact, n_iter=1000)
