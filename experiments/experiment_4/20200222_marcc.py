...
def run_experiment(
    m, block_1, block_2, mean_1, mean_2, var_1, var_2, n_clusters, reps, tests
):
    ...
    to_append = [m, mean_1, mean_2, var_1, var_2, *omni_res, *mase_res]
    return to_append
...
def main(task_index):
    ...
    res_df.to_csv(
        f"./results/20200222_weighted_correct_nodes_{task_index}.csv", index=False
    )
